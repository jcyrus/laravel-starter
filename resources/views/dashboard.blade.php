    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Top Customers</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">Coming soon...</p>
            </div>

            <!-- Best Sellers Placeholder -->
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Best Sellers</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">Coming soon...</p>
            </div>
        </div>
    </div>
